...
<body>
    ...
    <script>
        ...
        window.powWorkerUrl  = <?php echo wp_json_encode( add_query_arg( 'ver', '2.1.0', plugin_dir_url( dirname( __FILE__ ) ) . 'assets/pow-worker.js' ) ); ?>;
    </script>
    <script src="<?php echo esc_url( add_query_arg( 'ver', '2.1.0', plugin_dir_url( dirname( __FILE__ ) ) . 'assets/pow-solver.js' ) ); ?>"></script>
</body>
</html>
